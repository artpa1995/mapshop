            ...
            <div class="row no-gutters">
                <div class="col-sm-12 align-self-center ">
                    <div class="sign-in-from bg-white">
                        ...
                        <p>Введите свой адрес электронной почты и пароль для доступа в личный кабинет.</p>
                        <form class="mt-4 sign-in-from-wrapper">
                            <div class="form-group data_inputs_wrapper">
                                <label for="exampleInputEmail1">Адрес электронной почты</label>
                                <input type="email" name="email" class="form-control mb-0" id="exampleInputEmail1" placeholder="Почта">
                                <span class="error_text error_email"></span>
                            </div>
                            <div class="form-group data_inputs_wrapper password_input_icons_wrapper">
                                <label for="exampleInputPassword1">Пароль</label>
                                <a href="/forgot-password-page" class="float-right">Забыли пароль?</a>
                                <input type="password" name="password" class="form-control mb-0 <?php if(isset($_SESSION['error'])): echo "active"; endif;?> " id="exampleInputPassword1" placeholder="Пароль">
                                ...
                                <span class="error_text error_password"<?php if(isset($_SESSION['error'])): echo "style='display:block'"; endif;?> ><?php if(isset($_SESSION['error'])): echo $_SESSION['error']['email_log']; endif;?> </span>
                            </div>
                            <div class="d-inline-block w-100 data_inputs_wrapper">
                                <div class="custom-control custom-checkbox d-inline-block mt-2 pt-1">
                                    <input type="checkbox" class="custom-control-input" name="remember" data-type="1" id="rememberMe" value="0">
                            ...
                            <div class="sign-info">
                                <span class="dark-color d-inline-block line-height-2">Нет учетной записи? <a href="/sign-up-page">Регистрация</a></span>
