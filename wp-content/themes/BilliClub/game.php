...
<html lang="en" dir="ltr">
  ...
  <head>
    ...
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="assets/css/styleMaps.css">

      <link rel="stylesheet" href="assets/css/menubottom1.css">

      <link rel="stylesheet" href="assets/css/birga.css">

      <!-- Custom Css -->

      <link rel="stylesheet" href="assets/css/hope-ui.css?v=1.0.2">  
  ...
  <body class="  ">
    ...
    <main class="main-content birga">
      ...
      <div class="conatiner-fluid content-inner p-0">
        ...
        <div class="map-container" id="map">
          ...
          <h2 class="text-center mt-5 pt-5 text-white">Игры</h2>
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-card grid-cols-3">
                      ...
                      <img src="img/game/1.png" class="img-fluid bg-soft-info rounded" alt="profile-image">

                      <img src="img/game/2.jpg" class="img-fluid bg-soft-primary rounded" alt="profile-image">

                      <img src="img/game/3.jpg" class="img-fluid bg-soft-info rounded" alt="profile-image">

                      <img src="img/game/4.png" class="img-fluid bg-soft-primary rounded" alt="profile-image">

                      <img src="img/game/5.png" class="img-fluid bg-soft-warning rounded" alt="profile-image">

                      <img src="img/game/7.jpg" class="img-fluid bg-soft-primary rounded" alt="profile-image">

                      <img src="img/game/8.jpg" class="img-fluid bg-soft-danger rounded" alt="profile-image">

                      <img src="img/game/9.jpg" class="img-fluid bg-soft-primary rounded" alt="profile-image">

                      <img src="img/game/10.png" class="img-fluid bg-soft-success rounded" alt="profile-image">
   ...
   <div class="pointuTopMenu">
    ...
    <img src="img/moneti.png" alt=""><span>1858</span>
   ...
   <div class="bottomMenuMain fixed-bottom sidebar-color">
    ...
    <div class="row mx-auto">
      ...
      <div class="col-3 text-center">
        ...
        <a href="index.html" class="bottomMenuMainP">
      ...
      <div class="col-3 text-center">
        ...
        <a href="birga.html" class="bottomMenuMainP">
      ...
      <div class="col-3 text-center">
        ...
        <a href="chat/chat.html" class="bottomMenuMainP">
